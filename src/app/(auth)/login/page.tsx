        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-slate-800/0 px-2 text-slate-400">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-700 bg-slate-900/50 px-4 py-3 text-sm font-medium text-white hover:bg-slate-900 transition-all"
            >
